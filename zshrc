...
export PATH="/opt/local/bin:/opt/local/sbin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/go/bin:$HOME/bin:$HOME/.local/bin"
...
elif [[ "`hostname`" == "m3-512g-4tb.local" ]]; then
  PROMPT+=' %{$fg[green]%}%m:'
